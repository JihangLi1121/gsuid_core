...
发送【sr登录】or【zzz登录】打开网页登录绑定Cookie!
或发送【{_start}扫码登陆】扫码绑定(仅国服)"""
...
ERROR_CODE = {
    -51: CK_HINT,
    -100: "您的Cookie已失效! 请发送【sr登录】重新绑定",
    -503: CK_HINT,
    10001: "您的Cookie已失效! 请发送【sr登录】重新绑定",
    10101: "当前查询CK已超过每日30次上限!",
    10102: "当前查询id已经设置了隐私, 无法查询!",
    1034: VERIFY_HINT,
    -10001: "请求体出错, 请检查具体实现代码...",
    -201: "你的账号可能已被封禁, 请联系米游社客服...",
    1008: "该API需要Cookie, 请发送【sr登录】绑定账号",
